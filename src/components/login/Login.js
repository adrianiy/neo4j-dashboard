...
export const getSuggestionValue = (suggestion) => suggestion.uri;

// Use your imagination to render suggestions.
export const renderSuggestion = (suggestion) => <span>{suggestion.uri}</span>;
...
function Login(props) {
        ...
        try {
            ...
            if (sess && sess.id) {
                ...
                localStorage.setItem(
                    "neo4jDash.loginHistory",
                    JSON.stringify(history.filter((h) => h.uri !== uri).concat({ uri }))
                );
    ...
    return (
        <ColumnLayout dist="center" data-testid="login">
            ...
            <form data-testid="form" onSubmit={onLogin} autoComplete="on">
                <ColumnLayout dist="center">
                    ...
                    <button data-testid="submit" className={styles.button} type="submit">
                        Login
                    </button>
                </ColumnLayout>
            </form>
